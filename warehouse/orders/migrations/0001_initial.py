    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Delivering', 'Delivering'), ('Packed', 'Packed'), ('Received', 'Received'), ('In_progress', 'In_progress')], default='In_progress', max_length=30, verbose_name='Status')),
